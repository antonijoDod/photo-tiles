    ...
    <div className="px-4">
      <div className="flex">
        <div className="w-1/3">
          ...
          <p className="pt-5">
            Donec luctus mauris vestibulum, cursus risus in, malesuada augue.
            Nullam ac efficitur sapien. Fusce tincidunt metus sed convallis
            mattis.
          </p>
        </div>
        <div className="w-1/3">
          ...
          <ul className="mt-5">
            <li>
              <p>
                Address: <span>New Way 5, NY, USA</span>
              </p>
            </li>
            <li>
              <p className="mt-2">
                Email: <span>info@red-tiles.com</span>
              </p>
            </li>
          </ul>
        </div>
          ...
          <form className="mt-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="mt-5">
              <input
                type="submit"
                value="Subscribe!"
                className="text-white font-bold px-8 py-3 rounded-lg bg-pink-500 shadow-xl hover:bg-pink-700 cursor-pointer"
      ...
      <hr className="my-5"/>
        <div className="flex justify-between">
            <span className="text-sm text-gray-700">Copyright PHOTO-TILES 2020</span>
